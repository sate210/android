...
char MASS_STORAGE_FILE_PATH[48] = {0};
//fighter--
...
//fighter++
 if(!strcmp(label,"/mnt/sdcard")){
 		snprintf(MASS_STORAGE_FILE_PATH,sizeof("/sys/devices/platform/usb_mass_storage/lun0/file"),"/sys/devices/platform/usb_mass_storage/lun0/file");
 	}
// 	else if(!strcmp(label,"/mnt/ext_sd")){
// 		snprintf(MASS_STORAGE_FILE_PATH,sizeof("/sys/devices/platform/usb_mass_storage/lun1/file"),"/sys/devices/platform/usb_mass_storage/lun1/file");
// 	}else{
// 		snprintf(MASS_STORAGE_FILE_PATH,sizeof("/sys/devices/platform/usb_mass_storage/lun0/file"),"/sys/devices/platform/usb_mass_storage/lun0/file");
// 	}
//fighter--
