...
static int read_wifi_state()
{
	  int nwr, ret, fd_state;
    char buffer[4];
...
static int write_wifi_state(int value)
{
    int nwr, ret, fd_state;
    char buffer[4];
...
//static int read_3g_power_state()
//{
//}
static int set_3g_power(int value)
{
    int nwr, ret, fd_state;
    char buffer[4];
